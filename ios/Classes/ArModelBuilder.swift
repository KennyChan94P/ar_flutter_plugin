    ...
    func makeNodeFromGltf(name: String, modelPath: String, transformation: Array<NSNumber>?) -> SCNNode? {
        ...
        do {
            ...
            for child in scene.rootNode.childNodes {
                ...
                child.scale = SCNVector3(0.5,0.5,0.5) // Compensate for the different model dimension definitions in iOS and Android (meters vs. millimeters)
                // child.scale = SCNVector3(0.1,0.1,0.1) // Compensate for the different model dimension definitions in iOS and Android (meters vs. millimeters)
